...
class CommonPlatform ():
    PackagesSupported = ("eldenPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('elden', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "elden", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "eldenPkg/elden.dsc", "Platform Hardcoded")
